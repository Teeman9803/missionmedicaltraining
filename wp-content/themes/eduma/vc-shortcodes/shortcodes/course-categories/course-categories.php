...
function thim_shortcode_course_categories( $atts ) {
	...
	$widget_template       = THIM_DIR . 'inc/widgets/course-categories/tpl/' . $instance['layout'] . '-v1.php' ;
	$child_widget_template = THIM_CHILD_THEME_DIR . 'inc/widgets/course-categories/' . $instance['layout'] . '-v1.php';
