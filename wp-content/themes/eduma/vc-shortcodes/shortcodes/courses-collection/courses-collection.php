...
function thim_shortcode_courses_collection( $atts ) {
	...
	$widget_template       = THIM_DIR . 'inc/widgets/courses-collection/tpl/base.php';
	$child_widget_template = THIM_CHILD_THEME_DIR . 'inc/widgets/courses-collection/base.php';
