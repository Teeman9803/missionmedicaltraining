...
<div id="post-<?php the_ID(); ?>" <?php post_class($class); ?>>
	...
	<div class="item">
		<div class="thumbnail">
			...
			echo thim_get_feature_image( get_post_thumbnail_id( get_the_ID() ), 'large', apply_filters( 'thim_collection_item_thumbnail_width', 300 ), apply_filters('thim_collection_item_thumbnail_height', 300), get_the_title() );
			echo '</a>';
			?>
