...
?>
<h3 class="box-title"><?php echo esc_html('Your commission','learnpress-commission'); ?></h3>
<p>Total:
...
?>
<h3 class="box-title"><?php _e('Withdrawal History','learnpress-commission'); ?></h2>
...
<h3 class="box-title"><?php echo __('Withdrawal','learnpress-commission'); ?></h2>
<?php
